...
export default class ReportGenerator {
    ...
    constructor(airgramClient: AirgramClient, freeUserRepository: FreeUserRepository, statsDao: StatsDao, channelId: number, channelIdToSend: number) {
...
${await this.botConversationsStats()}
        `
        await this._airgramClient.sendMessageToChannel(formattedChannelId, report)
    }
